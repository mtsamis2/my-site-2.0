    ...
    <div>
        ...
        <section id="sidebar">
            ...
            <section className="blurb">
                <h2>About</h2>
                <p>
                    I am a Senior Software Engineer based in New York City. 
                    ...
                    In my free time, I enjoy coding side projects, tinkering with the latest gadgets, marathon running, and traveling.
                </p>
                <p>
