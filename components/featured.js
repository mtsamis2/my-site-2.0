        ...
        <section>
            ...
            <ul className="posts">
                <li>
                    <article>
                        <header>
                            <h3><a href="https://www.prettyprintjson.com/" target="_blank">PrettyPrintJSON.com</a></h3>
                        ...
                        <a href="https://www.prettyprintjson.com/" target="_blank" className="image" loading='lazy'>
                            <Image
                                src="/images/pretty.ico"
                                alt="a vector image of a computer with different color components meant to look like a React website."
                                aria-label="a vector image of a computer with different color components meant to look like a React website."
                                loading='lazy'
                                fill
